...
function Login(props) {
  ...
  return (
    ...
    <div className="h-[80%] flex flex-col items-center justify-center px-6 md:px-16 ">
        <div className="bg-background dark:bg-textPrimary w-[300px] md:w-[500px]  rounded-3xl backdrop-blur flex flex-col items-center px-8 py-12 md:px-10 md:py-14 shadow">
