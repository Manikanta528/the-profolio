...
function YourWorkPage(props) {
  ...
  // to toggle the add work form
  const [workToggle, setWorkToggle] = useState(false);

  // to upload the project image
  const [projectImg, setProjectImg] = useState();

  // to store the project details for adding to the database
  ...
  // to store the projects of the user
  const [projects, setProjects] = useState([]);

  // to trigger the useEffect when a new project is added
  ...
  // to handle work toggle
  const handleAddWork = () => {
    setWorkToggle(!workToggle);
  }

  // to handle skills/used technology
  ...
  // to validate the form projects data
  const validateForm = () => {
    const newErrors = {};
  ...
  // to create the project in database
  ...
  // to check if the user has added any projects or not
  ...
  // to get the projects of the user on page load and when a new project is added
  useEffect(() => {
    const accountDetails = account.get();
    accountDetails.then(
      function (response) {
