    ...
    <div className="font-inter h-fit bg-background dark:bg-backgroundDark  max-h-fit min-h-screen">
      ...
      <main className=' pt-32 lg:pt-44 px-6 md:px-16 flex flex-col justify-center items-center pb-0 sm:pb-24' >
        ...
        <div className='flex  flex-col gap-8 py-12 sm:flex-row sm:gap-12'>
          <button className='font-bold bg-primary rounded px-6 py-3  text-textPrimaryDark dark:text-textPrimary flex items-center gap-2 hover:shadow-2xl  active:shadow dark:shadow-slate-100/20' onClick={authRedirect} data-aos="fade-right" data-aos-anchor="#example-anchor" data-aos-offset="100" data-aos-duration="5000"> Sign in<FaArrowRight className='inline' /></button>
          <a href="https://github.com/Manikanta528/the-profolio" target='_blank' rel='noreferrer'><button className='font-bold bg-slate-400/30 rounded px-6 py-3 text-textPrimary dark:text-textPrimaryDark flex items-center gap-2 hover:shadow-2xl  active:shadow dark:shadow-slate-100/20' data-aos="fade-left" data-aos-anchor="#example-anchor" data-aos-offset="100" data-aos-duration="5000"><FaGithub className='inline' /> <div>GitHub</div></button></a>
        </div>
