...
function ProjectCard(props) {
  ...
  return (
    <Link  to="/project-overview" state={{data : props.data , findFlag : props.findFlag, discoverFlag : props.discoverFlag}} className="group bg-cover dark:shadow-white/10 text-textPrimary dark:text-textPrimaryDark dark:border-textPrimaryDark text-base sm:text-lg  w-full h-64 sm:w-96  rounded-2xl  hover:shadow-2xl  cursor-pointer"  >
