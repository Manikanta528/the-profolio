...
function ProfileCard(props) {
  ...
  return (
    <div className="relative max-h-fit w-[208px]  border-[1px] border-backgroundDark/10 dark:border-background/10 py-8 px-6 flex flex-col items-center rounded-md hover:shadow-2xl  hover:border-white/0 hover:top-[-10px]" data-aos="fade-up"  >
